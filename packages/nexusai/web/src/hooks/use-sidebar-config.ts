...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  '/admin/playground': { section: 'chat', module: 'playground' },
  '/admin/dashboard': { section: 'console', module: 'detail' },
  '/admin/dashboard/overview': { section: 'console', module: 'detail' },
  '/admin/dashboard/models': { section: 'console', module: 'detail' },
  '/admin/dashboard/users': { section: 'console', module: 'detail' },
  '/admin/keys': { section: 'console', module: 'token' },
  '/admin/usage-logs': { section: 'console', module: 'log' },
  '/admin/usage-logs/common': { section: 'console', module: 'log' },
  '/admin/usage-logs/audit': { section: 'console', module: 'audit' },
  '/admin/usage-logs/drawing': { section: 'console', module: 'midjourney' },
  '/admin/usage-logs/task': { section: 'console', module: 'task' },
  '/admin/wallet': { section: 'personal', module: 'topup' },
  '/admin/profile': { section: 'personal', module: 'personal' },
  '/admin/security': { section: 'personal', module: 'security' },
